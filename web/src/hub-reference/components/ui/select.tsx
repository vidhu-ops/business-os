...
// Wrapped icon components to filter Figma props
const CheckIcon = React.forwardRef<SVGSVGElement, React.ComponentProps<typeof CheckIconBase>>((props, ref) => {
  const cleanProps = filterFigmaProps(props);
  return <CheckIconBase ref={ref} {...cleanProps} />;
});
CheckIcon.displayName = "CheckIcon";

const ChevronDownIcon = React.forwardRef<SVGSVGElement, React.ComponentProps<typeof ChevronDownIconBase>>((props, ref) => {
  const cleanProps = filterFigmaProps(props);
  return <ChevronDownIconBase ref={ref} {...cleanProps} />;
});
ChevronDownIcon.displayName = "ChevronDownIcon";

const ChevronUpIcon = React.forwardRef<SVGSVGElement, React.ComponentProps<typeof ChevronUpIconBase>>((props, ref) => {
  const cleanProps = filterFigmaProps(props);
  return <ChevronUpIconBase ref={ref} {...cleanProps} />;
});
